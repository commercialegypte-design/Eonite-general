...
const PRODUCTS = [
  { id: '1', name: 'Sac Kraft Poignées Plates', category: 'sacs_kraft', description: 'Sac kraft classique avec poignées plates. Idéal pour la vente à emporter.', priceFrom: '0.18', minQty: 500, sizes: ['S', 'M', 'L'] },
  { id: '2', name: 'Sac Kraft Poignées Torsadées', category: 'sacs_kraft', description: 'Sac kraft premium avec poignées torsadées. Look haut de gamme.', priceFrom: '0.22', minQty: 500, sizes: ['M', 'L'] },
  { id: '3', name: 'Boîte Burger Kraft', category: 'boites', description: 'Boîte burger en carton kraft. Résistante et éco-responsable.', priceFrom: '0.15', minQty: 1000, sizes: ['S', 'M', 'L'] },
  { id: '4', name: 'Boîte Pizza', category: 'boites', description: 'Boîte pizza en carton ondulé. Plusieurs tailles disponibles.', priceFrom: '0.25', minQty: 500, sizes: ['26cm', '33cm', '40cm'] },
  { id: '5', name: 'Sac Shopping Luxe Côtelé', category: 'luxe', description: 'Sac shopping luxe avec finition côtelée. Impression premium.', priceFrom: '0.35', minQty: 500, sizes: ['Custom'] },
  { id: '6', name: 'Gobelet Carton Simple Paroi', category: 'gobelets', description: 'Gobelet carton classique pour boissons chaudes.', priceFrom: '0.045', minQty: 1000, sizes: ['4oz', '8oz', '12oz'] },
  { id: '7', name: 'Gobelet Ripple Wall', category: 'gobelets', description: 'Gobelet triple paroi ondulé. Isolation maximale.', priceFrom: '0.08', minQty: 1000, sizes: ['8oz', '12oz'] },
  { id: '8', name: 'Sac Expédition Mailing', category: 'expedition', description: 'Sac d\'expédition auto-adhésif en LDPE co-extrudé.', priceFrom: '0.12', minQty: 500, sizes: ['S', 'M', 'L', 'XL'] },
];
          ...
          {filteredProducts.length > 0 ? (
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {filteredProducts.map((product) => (
                <div key={product.id} className="bg-[#F9F8EF] border border-[#6B705C] card-hover group">
                  <div className="aspect-square bg-[#CDCEBD] flex items-center justify-center">
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-[#6B705C]/20">
                      <div>
                        ...
                        <p className="text-[#6B705C] font-bold text-xl">{product.priceFrom} €</p>
                      </div>
                      <Link to={`/contact?product=${encodeURIComponent(product.name)}`}>
                        <Button size="sm" className="btn-primary text-sm">Devis</Button>
                      </Link>
                    </div>
                  </div>
                </div>
